    ...
    >
      <motion.div className="textContainer" variants={varients}>
        ...
        <motion.div className="item" variants={varients}>
          <h2>Mail</h2>
          <span>mishansavaliya843@gmail.com</span>
        </motion.div>
        <div className="item">
          <h2>Address</h2>
          <span>205, Platinum Point, Surat, Gujarat</span>
        </div>
        <div className="item">
          <h2>Phone</h2>
          <span>+91 9558841100</span>
        </div>
      </motion.div>
      <div className="formContainer">
        ...
        >
          ...
          <textarea placeholder="Message" rows={2} name="message" />
